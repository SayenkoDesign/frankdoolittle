...
(function ($) {
    ...
    // remove a single design from a quote
    $('#modal-design').on('click', '.close-btn', removeDesignFromQuote);
    
    // remove all designs from a quote
    $('#modal-design .clear-all').on('click', removeAllDesignsFromQuote);
    
    // remove a single product from a quote
    $('#modal-product').on('click', '.close-btn', function(e){
        removeProductFromQuote(e);
    });
    
    // remove designs & products
    $('#modal-product .clear-all').on('click', function(e){
        removeAllProductsFromQuote(e);
        removeAllItemsFromQuotes(e);
    });
    
    $('#modal-quotes .clear-all').on('click', function(e){
        removeAllProductsFromQuote(e);
        removeAllItemsFromQuotes(e);
    });
    ...
    function addFavoritesToQuote(e) {
        ...
        $('.column input[type="hidden"]', $favorites_modal ).each(function () {
    ...
    function removeDesignFromQuote(e) {
        
        //log('removeDesignFromQuote');
        ...
        if(exists) {
           trigger_error( 'Design cannot be removed, it has been added to a package.', $modal );
           return; 
        }
    ...
    function removeAllDesignsFromQuote(e) {
        
        //log('removeAllDesignsFromQuote');
        e.preventDefault();
        ...
        if( ! remove_ids.length ) {
            trigger_error( 'Designs added to packages cannot be deleted.', $modal );
            return;
        } 
    ...
    function removeAllItemsFromQuotes(e) {
        
        // we need to remove all items from modals: quotes, product, design 
        e.preventDefault();
        ...
        if( ! remove_ids.length ) {
            trigger_error( 'Items added to packages cannot be deleted.', $modal );
            return;
        } 
    ...
    function removeProductFromQuote(e) {
        
        //log('removeProductFromQuote');
        ...
        if(exists) {
           trigger_error( 'Product cannot be removed, it has been added to a package.', $modal );
           return; 
        }
    ...
    function removeAllProductsFromQuote(e) {
        
        //log('removeAllProductsFromQuote');
        e.preventDefault();
        ...
        if( ! remove_ids.length ) {
            trigger_error( 'Products added to packages cannot be deleted.', $modal );
            return;
        }        
