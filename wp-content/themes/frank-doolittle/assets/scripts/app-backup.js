...
(function ($) {
    ...
    // Remove single product/design from quote
    $('#quotes-modal').on('click', '.close-btn', removeFavorite);
    ...
    $('#modal-product').on('click', '.close-btn', removeProductFromQuote);
    
    // remove all designs from a quote
    $('#modal-product .clear-all').on('click', removeAllProductsFromQuote);
    ...
    function addItemToFavoriteModal(data, type ) {
        ...
        $favorites_modal.find('.' + type + '-grid').append(html);
    }
    ...
    function removeFavorite(e) {
        ...
        callResource({
            ...
            removeFromModal($favorites_modal,response);            
    ...
    function removeFromModal(modal, response) {
        ...
        _.each(response.post_ids, function (id) {
         ...
         // Hide empty parent
        //$(".grid:empty", modal ).parents('.grid-container').hide();
    }
    ...
    function addFavoritesToQuote(e) {
        ...
        callResource({
            ...
            removeFromFavoritesModal(response);
