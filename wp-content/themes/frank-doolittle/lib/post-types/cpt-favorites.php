...
/**
 * Create new CPT - Favorites
 */

class CPT_Favorites extends CPT_Core {

    const POST_TYPE = 'doolittle_favorite';
	const TEXTDOMAIN = '_s';
    ...
    public function __construct() {
        ...
        parent::__construct(
        	...
        	array(
				__( 'Favorite', self::TEXTDOMAIN ), // Singular
				__( 'Favorites', self::TEXTDOMAIN ), // Plural
